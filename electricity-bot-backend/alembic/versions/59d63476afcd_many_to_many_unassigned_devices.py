...
def upgrade():
    ...
    op.create_table('unassigned_devices',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('devices', sa.Column('owner_id', mysql.VARCHAR(length=255), nullable=False))
    op.add_column('devices', sa.Column('owner_email', mysql.VARCHAR(length=255), nullable=False))
