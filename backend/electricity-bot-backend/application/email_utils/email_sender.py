  ...
  <tr>
    <td align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" width="640"
        ...
        <tr><td align="center" style="font-size:64px;line-height:1">💡</td></tr>
        <tr><td align="center"
        ...
        <tr><td style="font-size:17px;line-height:1.6;color:#2b2b2b;padding-top:24px">
            You’ve just joined <span style="color:#4285f4;font-weight:600">
            Electricity Bot</span> – your smart sidekick for when the lights go out.
        </td></tr>
        <tr><td style="font-size:14px;color:#777;padding-top:40px;text-align:center">
            ✨ No need to reply – this message was generated by a very smart basement ⚙️
        </td></tr>
      </table>
    </td>
  </tr>
...
def send_welcome_email(to_email: str, first_name: str = "friend") -> None:
    if not SMTP_EMAIL or not SMTP_PASSWORD:
        raise RuntimeError("SMTP_EMAIL / SMTP_PASSWORD не задані!")

    html_raw = HTML_TMPL(first_name=first_name)
    html_inline = transform(html_raw)

    text_part = MIMEText(
        f"Hi {first_name}! Welcome to Electricity Bot – your smart sidekick for "
        "blackouts.\n\n(No reply needed.)",
        "plain",
        "utf-8",
    )
    ...
    msg["Subject"] = "💡 Welcome to Electricity Bot!"
    msg["From"] = SMTP_EMAIL
    msg["To"] = to_email
    ...
    try:
        ...
        logger.error(f"[Email] ERROR → {exception}")
        raise
